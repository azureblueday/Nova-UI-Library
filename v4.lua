...
function module.new(library_title, cfg_location)
    ...
    function menu.new_tab(tab_image)
        ...
        if is_first_tab then
            ...
            TabImage.ImageColor3 = Color3.fromRGB(128, 0, 128)
            Tab.Visible = true
        end
        ...
        TabButton.MouseButton1Down:Connect(function()
            ...
            Tab.Visible = true
            selected_tab = TabButton
            module:tween(TabImage, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {ImageColor3 = Color3.fromRGB(128, 0, 128)})
        end)
        ...
        function tab.new_section(section_name)
            ...
            local UIGradient = module:create("UIGradient", {
                Color = ColorSequence.new{ColorSequenceKeypoint.new(0, Color3.fromRGB(32, 33, 38)), ColorSequenceKeypoint.new(0.5, Color3.fromRGB(128, 0, 128)), ColorSequenceKeypoint.new(1, Color3.fromRGB(32, 33, 38))},
            }, SectionDecoration)
            ...
            SectionButton.MouseButton1Down:Connect(function()
                ...
                module:tween(SectionButton, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {TextColor3 = Color3.fromRGB(128, 0, 128)})
            ...
            if is_first_section then
                ...
                SectionButton.TextColor3 = Color3.fromRGB(128, 0, 128) 
                ...
                function sector.element(type, text, data, callback, c_flag)
                    ...
                    if type == "Toggle" then
                        ...
                        function element:set_value(new_value, cb)
                            ...
                            if value.Toggle then
                                module:tween(ToggleFrame, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {BackgroundColor3 = Color3.fromRGB(128, 0, 128)})
                        ...
                        function element:add_keybind(key_default, key_callback)
                            ...
                            KeybindFrame.MouseEnter:Connect(function()
                                keybind_in2 = true
                                module:tween(KeybindFrame, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {BorderColor3 = Color3.fromRGB(128, 0, 128)})
                            end)
                            ...
                            for _,TypeButton in next, KeybindFrame:GetChildren() do
                                ...
                                TypeButton.MouseButton1Down:Connect(function()
                                    ...
                                    module:tween(TypeButton, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {TextColor3 = Color3.fromRGB(128, 0, 128)})
                                end)
                            end
                            ...
                            function keybind:set_value(new_value, cb)
                                ...
                                for _,TypeButton2 in next, KeybindFrame:GetChildren() do
                                    ...
                                    if TypeButton2.Name ~= extra_value.Type then
                                        ...
                                        module:tween(TypeButton2, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {TextColor3 = Color3.fromRGB(128, 0, 128)})
                                    end
                                end
                        ...
                        function element:add_color(color_default, has_transparency, color_callback)
                            ...
                            ColorFrame.MouseEnter:Connect(function()
                                in_color = true
                                module:tween(ColorFrame, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {BorderColor3 = Color3.fromRGB(128, 0, 128)})
                            end)
                    ...
                    elseif type == "TextBox" then
                        ...
                        uis.TextBoxFocused:connect(function()
                            if uis:GetFocusedTextBox() == TextBox then
                                module:tween(TextBox, TweenInfo.new(0.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {BorderColor3 = Color3.fromRGB(128, 0, 128)})
                            end
                        end)
                    ...
                    elseif type == "Scroll" then
                        ...
                        local ScrollFrame = module:create("ScrollingFrame", {
                            ...
                            TopImage = "rbxasset://textures/ui/Scroll/scroll-middle.png",
                            AnchorPoint = Vector2.new(0.5, 0),
                            ScrollBarImageColor3 = Color3.fromRGB(128, 0, 128),
                        }, Scroll)
                    ...
                    elseif type == "Slider" then
                        ...
                        local UIGradient = module:create("UIGradient", {
                            Color = ColorSequence.new{ColorSequenceKeypoint.new(0, Color3.fromRGB(128, 0, 128)), ColorSequenceKeypoint.new(1, Color3.fromRGB(90, 0, 90))},
                            Rotation = 90,
                        }, SliderFrame)
