...
-- ═══════════════════════════════════════════════
-- CREATE WINDOW
-- cfg can be a string (title only) or table {Title, Subtitle, Size, MobileSize}
-- ═══════════════════════════════════════════════
function lib:CreateWindow(cfg)
	...
	NavScroll.CanvasSize = UDim2.new(0, 0, 5, 0)
	...
	function lib:CreateButton(title, parent, tip, callback)
		...
		t.BackgroundTransparency=1; t.Position=UDim2.new(0,14,0,0); t.Size=UDim2.new(1,-28,0,36)
		...
		d.BackgroundTransparency=1; d.Position=UDim2.new(0,14,0,28); d.Size=UDim2.new(1,-28,0,30)
		d.Font=Enum.Font.Gotham; d.Text=tip; d.TextColor3=Color3.fromRGB(140,120,180)
		d.TextSize=12; d.TextTransparency=1; d.TextXAlignment=Enum.TextXAlignment.Left
		...
		Btn.MouseEnter:Connect(function()
			TweenService:Create(Btn,TweenInfo.new(0.25),{Size=UDim2.new(0.97,0,0,60)}):Play()
			TweenService:Create(d,TweenInfo.new(0.25),{TextTransparency=0.4}):Play()
			TweenService:Create(sg,TweenInfo.new(0.3),{Rotation=180}):Play()
		end)
		Btn.MouseLeave:Connect(function()
			TweenService:Create(Btn,TweenInfo.new(0.25),{Size=UDim2.new(0.97,0,0,36)}):Play()
			TweenService:Create(d,TweenInfo.new(0.25),{TextTransparency=1}):Play()
			TweenService:Create(sg,TweenInfo.new(0.3),{Rotation=0}):Play()
		end)
	...
	function lib:CreateToggle(title, parent, default, tip, callback)
		...
		tl.BackgroundTransparency=1; tl.Position=UDim2.new(0,14,0,0); tl.Size=UDim2.new(0,320,0,36)
		...
		local dl = Instance.new("TextLabel", Toggle)
		dl.BackgroundTransparency=1; dl.Position=UDim2.new(0,14,0,28); dl.Size=UDim2.new(1,-28,0,30)
		dl.Font=Enum.Font.Gotham; dl.Text=tip; dl.TextColor3=Color3.fromRGB(140,120,180)
		dl.TextSize=12; dl.TextTransparency=1; dl.TextXAlignment=Enum.TextXAlignment.Left
		...
		Toggle.MouseEnter:Connect(function()
			TweenService:Create(Toggle,TweenInfo.new(0.25),{Size=UDim2.new(0.97,0,0,60)}):Play()
			TweenService:Create(dl,TweenInfo.new(0.25),{TextTransparency=0.4}):Play()
		end)
		Toggle.MouseLeave:Connect(function()
			TweenService:Create(Toggle,TweenInfo.new(0.25),{Size=UDim2.new(0.97,0,0,36)}):Play()
	...
	function lib:CreateInput(title, parent, tip, callback)
		...
		tl.BackgroundTransparency=1; tl.Position=UDim2.new(0,14,0,0); tl.Size=UDim2.new(0,280,0,36)
		tl.Font=Enum.Font.GothamMedium; tl.Text=title; tl.TextColor3=Color3.fromRGB(200,170,255)
		tl.TextSize=14; tl.TextTransparency=0.3; tl.TextXAlignment=Enum.TextXAlignment.Left

		local dl = Instance.new("TextLabel", Input)
		dl.BackgroundTransparency=1; dl.Position=UDim2.new(0,14,0,28); dl.Size=UDim2.new(1,-28,0,30)
		dl.Font=Enum.Font.Gotham; dl.Text=tip; dl.TextColor3=Color3.fromRGB(140,120,180)
		dl.TextSize=12; dl.TextTransparency=1; dl.TextXAlignment=Enum.TextXAlignment.Left
		...
		Input.MouseEnter:Connect(function()
			TweenService:Create(Input,TweenInfo.new(0.25),{Size=UDim2.new(0.97,0,0,60)}):Play()
			TweenService:Create(dl,TweenInfo.new(0.25),{TextTransparency=0.4}):Play()
		end)
		Input.MouseLeave:Connect(function()
			TweenService:Create(Input,TweenInfo.new(0.25),{Size=UDim2.new(0.97,0,0,36)}):Play()
			TweenService:Create(dl,TweenInfo.new(0.25),{TextTransparency=1}):Play()
		end)
	...
	function lib:CreateDropdown(title, parent, options, tooltip, callback)
		...
		tl.BackgroundTransparency=1; tl.Position=UDim2.new(0,14,0,0); tl.Size=UDim2.new(0,300,0,36)
		tl.Font=Enum.Font.GothamMedium; tl.Text=title; tl.TextColor3=Color3.fromRGB(200,170,255)
		tl.TextSize=14; tl.TextTransparency=0.3; tl.TextXAlignment=Enum.TextXAlignment.Left

		local sel = Instance.new("TextLabel", Drop)
		sel.BackgroundTransparency=1; sel.Position=UDim2.new(1,-80,0,0); sel.Size=UDim2.new(0,65,0,36)
		...
		local dl = Instance.new("TextLabel", Drop)
		dl.BackgroundTransparency=1; dl.Position=UDim2.new(0,14,0,28); dl.Size=UDim2.new(1,-28,0,30)
		dl.Font=Enum.Font.Gotham; dl.Text=tooltip; dl.TextColor3=Color3.fromRGB(140,120,180)
		dl.TextSize=12; dl.TextTransparency=1; dl.TextXAlignment=Enum.TextXAlignment.Left

		local of = Instance.new("Frame", Drop)
		of.BackgroundColor3=Color3.fromRGB(14,10,24); of.Position=UDim2.new(1,-90,1,4)
		of.Size=UDim2.new(0,80,0,0); of.Visible=false; of.AutomaticSize=Enum.AutomaticSize.Y; of.ZIndex=10
		...
		for _, opt in ipairs(options) do
			...
			ob.TextSize=13; ob.TextTransparency=0.2; ob.ZIndex=11
			ob.MouseButton1Click:Connect(function() sel.Text=opt; of.Visible=false; callback(opt) end)
		end

		local db = false
		Drop.MouseButton1Click:Connect(function()
			if db then return end; db=true; of.Visible=not of.Visible; task.delay(0.15, function() db=false end)
		end)

		Drop.MouseEnter:Connect(function()
			TweenService:Create(Drop,TweenInfo.new(0.25),{Size=UDim2.new(0.97,0,0,60)}):Play()
			TweenService:Create(dl,TweenInfo.new(0.25),{TextTransparency=0.4}):Play()
		end)
		Drop.MouseLeave:Connect(function()
			TweenService:Create(Drop,TweenInfo.new(0.25),{Size=UDim2.new(0.97,0,0,36)}):Play()
			TweenService:Create(dl,TweenInfo.new(0.25),{TextTransparency=1}):Play()
		end)
	end
	...
	function lib:CreateSlider(title, parent, min, max, default, prefix, tip, callback)
		...
		tl.BackgroundTransparency=1; tl.Position=UDim2.new(0,14,0,0); tl.Size=UDim2.new(0,140,0,36)
		tl.Font=Enum.Font.GothamMedium; tl.Text=title; tl.TextColor3=Color3.fromRGB(200,170,255)
		tl.TextSize=14; tl.TextTransparency=0.3; tl.TextXAlignment=Enum.TextXAlignment.Left

		local vl = Instance.new("TextBox", Sld)
		vl.BackgroundTransparency=1; vl.Position=UDim2.new(1,-65,0,0); vl.Size=UDim2.new(0,50,0,36)
		...
		local dl = Instance.new("TextLabel", Sld)
		dl.BackgroundTransparency=1; dl.Position=UDim2.new(0,14,0,28); dl.Size=UDim2.new(1,-28,0,30)
		dl.Font=Enum.Font.Gotham; dl.Text=tip; dl.TextColor3=Color3.fromRGB(140,120,180)
		dl.TextSize=12; dl.TextTransparency=1; dl.TextXAlignment=Enum.TextXAlignment.Left

		local tb = Instance.new("Frame", Sld)
		tb.BackgroundColor3=Color3.fromRGB(25,18,40); tb.Position=UDim2.new(0,150,0.5,-3); tb.Size=UDim2.new(0,220,0,6)
		...
		Sld.MouseEnter:Connect(function()
			TweenService:Create(Sld,TweenInfo.new(0.25),{Size=UDim2.new(0.97,0,0,60)}):Play()
			TweenService:Create(dl,TweenInfo.new(0.25),{TextTransparency=0.4}):Play()
		end)
		Sld.MouseLeave:Connect(function()
			TweenService:Create(Sld,TweenInfo.new(0.25),{Size=UDim2.new(0.97,0,0,36)}):Play()
			TweenService:Create(dl,TweenInfo.new(0.25),{TextTransparency=1}):Play()
		end)
