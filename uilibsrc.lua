...
local Theme = {
    ...
    BorderAccent = Color3.fromRGB(138, 43, 226),
...
function NovaUI:CreateGui()
    ...
    local versionBadge = Utility.Create("Frame", {
        ...
        Position = UDim2.new(0, 100, 0.5, -10),
...
function NovaUI:CreateControlButton(parent, icon, callback, hoverColor)
    ...
    btn.MouseEnter:Connect(function()
        ...
        Utility.Tween(btn.Icon, {ImageColor3 = hoverColor or Theme.AccentLight}, 0.2)
    end)
    ...
    if self.IsMobile then
        ...
        self.MobileToggle.InputEnded:Connect(function(input)
            if input.UserInputType == Enum.UserInputType.Touch then
                ...
                -- Only toggle if it was a quick tap without much movement
        ...
        task.spawn(function()
            while self.ScreenGui and self.ScreenGui.Parent do
                if self.MobileToggle and self.MobileToggle.Parent then
                    Utility.Tween(self.MobileToggle.UIStroke, {Transparency = 0.2}, 1)
                    task.wait(1)
                    Utility.Tween(self.MobileToggle.UIStroke, {Transparency = 0.8}, 1)
                    task.wait(1)
                end
            end
        end)
...
function NovaUI:CreateToggle(section, name, default, callback, flag)
    ...
    local function updateToggle()
        ...
        Utility.Tween(toggleCircle, {Position = toggle.Value and UDim2.new(1, -18, 0.5, -8) or UDim2.new(0, 2, 0.5, -8)}, 0.2, Enum.EasingStyle.Back)
    ...
    container.MouseEnter:Connect(function()
        Utility.Tween(container, {BackgroundColor3 = Color3.fromRGB(40, 40, 52)}, 0.2)
    end)
...
function NovaUI:CreateSlider(section, name, min, max, default, callback, flag)
    ...
    container.MouseEnter:Connect(function()
        Utility.Tween(container, {BackgroundColor3 = Color3.fromRGB(40, 40, 52)}, 0.2)
        Utility.Tween(sliderKnob, {Size = UDim2.new(0, 18, 0, 18)}, 0.2)
    end)
...
function NovaUI:CreateDropdown(section, name, options, default, callback, flag)
    ...
    header.MouseButton1Click:Connect(function()
        ...
        if dropdown.Open then
            Utility.Tween(container, {Size = UDim2.new(1, 0, 0, 38 + #options * 30 + 10)}, 0.2)
