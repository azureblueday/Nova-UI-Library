...
function NovaUI:CreateWindow(config)
    ...
    function Window:CreateTab(tabConfig)
        ...
        function Tab:CreateSlider(cfg)
            ...
            local label = Instance.new("TextLabel")
            label.BackgroundTransparency = 1
            label.Size = UDim2.new(1, Scale(-60), 0, Scale(22))
            ...
            valueLabel.Size = UDim2.new(0, Scale(50), 0, Scale(22))
            valueLabel.Position = UDim2.new(1, Scale(-60), 0, Scale(6))
            valueLabel.Font = Theme.FontMedium
            valueLabel.Text = tostring(value)
            valueLabel.TextColor3 = Theme.Accent
            valueLabel.TextSize = Scale(12)
            ...
            track.Size = UDim2.new(1, Scale(-28), 0, Scale(10))
            track.Position = UDim2.new(0, Scale(14), 1, Scale(-20))
            ...
            knob.Size = UDim2.new(0, Scale(18), 0, Scale(18))
            knob.Position = UDim2.new((value - min) / (max - min), Scale(-9), 0.5, Scale(-9))
            knob.Parent = track
