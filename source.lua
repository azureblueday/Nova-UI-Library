local Release = "discord.gg/getnova"

local Luna = { 
	Folder = "Luna", 
	Options = {}, 
	ThemeGradient = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(138, 43, 226)), ColorSequenceKeypoint.new(0.50, Color3.fromRGB(138, 43, 226)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(138, 43, 226))} 
}
